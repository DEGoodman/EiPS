#!/usr/bin/env python
import sys, re, string, sqlite3, os.path, time

## Constraints
# - The data exists beyond execution of the runtime of the programs that use it,
#     and/or data is used by many different programs
# - The data is stored in a way that makes it easier/faster to explore.
# - The problem is solved by queries over the data
