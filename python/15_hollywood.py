...
# - entities provide interfaces for other entities to register callbacks
# - At certain points, entities call on the other entities that have
...
class DataStorage:
    ...
    def __produce_words(self):
        """iterates though the list words in storage
