...
## Constraints
# - every function checks its args, jumps out of function when unreasonable
# - when calling other functions, only checks for errors if they are in a position to react meaningfully
# - Exception handling occurs at higher levels of the call chain
